 ...
 */
class ToolkitContext extends RawDrupalContext implements SnippetAcceptingContext {
    ...
    foreach ($pages as $page) {
      try {
        if (strpos($page, '%') !== false) {
          ...
          $this->visitPath($page);
          echo "\033[0;32m" . $page . "\033[0m\n";
        }
      }
      catch (Exception $e) {
        echo "\033[0;33m" . $page . "\033[0m\n";
      }
    }
  }
